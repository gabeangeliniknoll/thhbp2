...
of $ H\mathbb{Z}\otimes H\mathbb{Z}^{\op}$-modules, corresponding to a generator of $\mathrm{THC}^{2p}(\mathbb{Z})=\mathbb{Z}/p$. Here we use the equivalence 
\[ \map_{H\mathbb{Z}\otimes H\mathbb{Z}^{\op}}(H\mathbb{Z},H\mathbb{Z})\simeq \map_{H\mathbb{Z}}(\THH(\mathbb{Z}),H\mathbb{Z}) \,,
\]
...
\[
    ...
    \end{cases}
\]
to produce the isomorphism $\mathrm{THC}^{2p}(\mathbb{Z})=\mathbb{Z}/p$
\end{example}
