...
\bib{ACH24}{article}{
      author={Angelini-Knoll, Gabriel},
      author={Culver, Dominic~Leon},
      author={H{\"o}ning, Eva},
       title={Topological {Hochschild} homology of truncated {Brown}-{Peterson}
  spectra. {I}.},
    language={English},
        date={2024},
        ISSN={1472-2747},
...
\bib{AHL09}{incollection}{
      author={Angeltveit, Vigleik},
      author={Hill, Michael~A.},
      author={Lawson, Tyler},
       title={The spectra {$ko$} and {$ku$} are not {T}hom spectra: an approach
  using {$THH$}},
        date={2009},
...
\bib{BMS19}{article}{
      ...
      author={Scholze, Peter},
       title={Topological {H}ochschild homology and integral {$p$}-adic {H}odge
  theory},
        date={2019},
...
\bib{BCS10}{article}{
      ...
      author={Schlichtkrull, Christian},
       title={Topological {H}ochschild homology of {T}hom spectra and the free
  loop space},
        date={2010},
...
\bib{Bok85}{misc}{
      author={B\"okstedt, Marcel},
       title={Topological hochschild homology of $\mathbb{Z}/p$ and
  $\mathbb{Z}$},
        date={1985},
        note={Preprint},
}
...
\bib{BHLS23}{article}{
      ...
      author={{Schlank}, Tomer~M.},
       title={{$K$-theoretic counterexamples to Ravenel's telescope
  conjecture}},
        date={2023-10},
     journal={arXiv e-prints},
...
\bib{Cha25}{article}{
      author={{Chaminadour}, Maxime},
       title={{A computation of $THH_*(ku)$ using a gathered spectral
  sequence}},
        date={2025-11},
     journal={arXiv e-prints},
...
\bib{HW22}{article}{
      author={Hahn, Jeremy},
      author={Wilson, Dylan},
       title={Redshift and multiplication for truncated {Brown}-{Peterson}
  spectra},
    language={English},
        date={2022},
        ISSN={0003-486X},
...
\bib{HL10}{article}{
      author={Hill, Michael},
      author={Lawson, Tyler},
       title={Automorphic forms and cohomology theories on {Shimura} curves of
  small discriminant},
    language={English},
        date={2010},
        ISSN={0001-8708},
...
\bib{Hon20}{article}{
      author={H{\"o}ning, Eva},
       title={On the {Brun} spectral sequence for topological {Hochschild}
  homology},
    language={English},
        date={2020},
        ISSN={1472-2747},
...
\bib{LN12}{article}{
      author={Lawson, Tyler},
      author={Naumann, Niko},
       title={Commutativity conditions for truncated {Brown}-{Peterson} spectra
  of height 2},
    language={English},
        date={2012},
        ISSN={1753-8416},
...
\bib{LN14}{article}{
      author={Lawson, Tyler},
      author={Naumann, Niko},
       title={Strictly commutative realizations of diagrams over the {Steenrod}
  algebra and topological modular forms at the prime 2},
    language={English},
        date={2014},
        ISSN={1073-7928},
...
\bib{Laz01}{article}{
      author={Lazarev, A.},
       title={Homotopy theory of {$A_\infty$} ring spectra and applications to
  {$M{\rm U}$}-modules},
        date={2001},
...
\bib{Lee22}{misc}{
      author={Lee, David~Jongwon},
       title={Integral topological {Hochschild} homology of connective complex
  {K}-theory},
         how={Preprint, {arXiv}:2206.02411 [math.{AT}] (2022)},
        date={2022},
...
\bib{Mah87}{incollection}{
   ...
   publisher={Springer, Berlin},
       pages={293\ndash 297},
         url={https://doi.org/10.1007/BFb0078747},
      review={\MR{922932}},
}
...
\bib{Qui25}{article}{
  ...
  \href{https://ryquinn.github.io/}{https://ryquinn.github.io/}},
}
